...
actor WhisperKitService {
    ...
    private var modelName: String {
        UserDefaults.standard.string(forKey: "selectedModel") ?? "distil-whisper_distil-large-v3"
    }
    ...
    /// Encode text into token IDs using WhisperKit's tokenizer.
    /// This is used for creating prompt tokens for context conditioning.
