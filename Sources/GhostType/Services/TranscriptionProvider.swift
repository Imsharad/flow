...
/// Context to be passed for continuous transcription.
struct TranscriptionContext: Sendable {
    let text: String
    let tokens: [Int]
}

/// Result returned by transcription services.
...
protocol TranscriptionProvider: Sendable {
    ...
    /// - Parameter context: Optional context (text/tokens) from previous segments.
    /// - Returns: The transcribed result containing text, tokens and segments.
