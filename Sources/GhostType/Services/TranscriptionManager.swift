...
class TranscriptionManager: ObservableObject {
    ...
    func transcribe(buffer: AVAudioPCMBuffer, prompt: String? = nil, promptTokens: [Int]? = nil) async -> (String, [Int]?)? {
    ...
    private func performTranscription(buffer: AVAudioPCMBuffer, prompt: String?, promptTokens: [Int]?) async throws -> (String, [Int]?) {
        ...
        if currentMode == .cloud {
            do {
                ...
                return (text, nil) // Cloud service currently doesn't return tokens
            } catch {
